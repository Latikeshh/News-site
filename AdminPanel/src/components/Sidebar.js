...
const Sidebar = () => (
  <div className="bg-dark text-white p-3 vh-100 position-fixed" style={{ width: '220px' }}>
    <h5 className="mb-4">Talk Bharat Admin</h5>
    <Nav defaultActiveKey="/dashboard" className="flex-column">
      ...
      <Nav.Link as={Link} to="/contacted" className="text-white">Contacted Us</Nav.Link>
      <Nav.Link as={Link} to="/breakingNews" className="text-white">BreakingNews</Nav.Link>
